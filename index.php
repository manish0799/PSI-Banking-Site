...
<body>
  ...
  <div class="center head mt-0">
    <h2 class="main"><b><span><img src="./images/logo2.png" style="height: 65px;width: 60px;" /></span>PSI BANK<b></h2>
  </div>
        ...
        <div class="col s12 m6">
          <div class="card small">
            <div class="card-image">
              <img class="cust" src="./images/bank.jpg" style="width: 450px;height: 225px;padding-left: 45px;padding-right: 45px;">
            </div>
    ...
    <div class="col s4">
      ...
      <div class="row">
        <div class="col s12 m6">
          <div class="card small">
            <div class="card-image">
              <img src="./images/bank2.png" style="width: 390px;height: 180px;padding-right: 80px;padding-left: 50px;margin-left: 45px;padding-top: 10px;">
            </div>
            <br />

            <h5 class="neonText" style="height:54px;"><b style="position: relative;top: 20%;">Welcome to PSI Bank !</b></h5>
            <br />
    ...
    <div class="col s4">
      ...
      <div class="row">
        <div class="col s12 m6">
          <div class="card small">
            <div class="card-image">
              <img class="cust" src="./images/transaction.jpg" style="width: 231px; margin-left: 110px;">
            </div>
  ...
  <footer class="center footer">
    <h6 class="info"><b>2021 © Made by Manish Kumar Sharma </b></h6>
